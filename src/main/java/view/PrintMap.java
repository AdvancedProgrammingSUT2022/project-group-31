...
public class PrintMap {
    public static void run() {
        ...
        //line 2
        System.out.print(player.isHexVisible(database.Hex04()) ? (" /" + database.Hex00().getColor() + " (0,0) " + RESET + "\\" + "      ") : " / (0,0) \\      "); //hex(0,0)
        System.out.print(player.isHexVisible(database.Hex04()) ? (" /" + database.Hex02().getColor() + " (0,2) " + RESET + "\\" + "      ") : " / (0,2) \\      "); //hex(0,2)
        ...
        System.out.print(player.isHexVisible(database.Hex10()) ? (database.Hex12().getColor() + "       " + RESET + "/") : "       /"); //hex(1,2)
        System.out.print(player.isHexVisible(database.Hex13()) ? (database.Hex13().getColor() + " (1,3) " + RESET + BLUE + "\\" + RESET) : " (1,3) \\"); //hex(1,3)
        System.out.print(player.isHexVisible(database.Hex10()) ? (database.Hex14().getColor() + "       " + RESET + "/") : "       /"); //hex(1,4)
        ...
        System.out.print(player.isHexVisible(database.Hex11()) ? (database.Hex11().getColor() + "         " + RESET + "\\") : "         \\"); //hex(1,1)
        System.out.print(player.isHexVisible(database.Hex10()) ? (database.Hex12().getColor() + "_____" + RESET + "/") : "_____/"); //hex(1,2)
        System.out.print(player.isHexVisible(database.Hex13()) ? (database.Hex13().getColor() + "         " + RESET + BLUE + "\\" + RESET) : "         \\"); //hex(1,3)
        System.out.print(player.isHexVisible(database.Hex10()) ? (database.Hex14().getColor() + "_____" + RESET + "/") : "_____/"); //hex(1,4)
        System.out.print(player.isHexVisible(database.Hex15()) ? (database.Hex15().getColor() + "         " + RESET + "\\") : "         \\"); //hex(1,5)
        System.out.println();
