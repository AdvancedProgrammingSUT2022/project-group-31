...
public class PrintMap {
    public static void run() {
        ...
        System.out.print(database.Hex04().getColor() + "       " + RESET + "/"); //hex(0,4)
        System.out.print(database.Hex05().getColor() + " (0,5) " + RESET + "\\"); //hex(0,5)
        System.out.println();
        ...
        //line9
        System.out.print("/" + database.Hex10().getColor() + "         " + RESET + "\\"); //hex(1,0)
        System.out.print(database.Hex01().getColor() + "_____" + RESET + "/"); //hex(0,1)
        System.out.print(database.Hex12().getColor() + "         " + RESET + "\\"); //hex(1,2)
        ...
        System.out.print(database.Hex12().getColor() + "       " + RESET + "/"); //hex(1,2)
        System.out.print(database.Hex13().getColor() + " (1,3) " + RESET + "\\"); //hex(1,3)
        System.out.print(database.Hex14().getColor() + "       " + RESET + "/"); //hex(1,4)
        ...
        System.out.print(database.Hex22().getColor() + "       " + RESET + "/"); //hex(2,2)
        System.out.print(database.Hex23().getColor() + " (2,3) " + RESET + "\\"); //hex(2,3)
        System.out.print(database.Hex24().getColor() + "       " + RESET + "/"); //hex(2,4)
        ...
        System.out.print("\\" + database.Hex25().getColor() + "_____" + RESET + "/"); //hex(2,5)
        System.out.println();
