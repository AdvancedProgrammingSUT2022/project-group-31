...
public class PrintMap {
    public static void run() {
        ...
        //line 2
        System.out.print(" /" + GREEN + " (0,0) " + RESET + "\\" + "      "); //hex(0,0)
        System.out.print(" /" + GREEN + " (0,2) " + RESET + "\\" + "      "); //hex(0,2)
        System.out.print(" /" + GREEN + " (0,4) " + RESET + "\\" + "      "); //hex(0,4)
        System.out.println();

        //line3
        System.out.print("/" + GREEN + "         " + RESET + "\\" + "_____"); //hex(0,0)
        System.out.print("/" + GREEN + "         " + RESET + "\\" + "_____"); //hex(0,2)
        System.out.print("/" + GREEN + "         " + RESET + "\\" + "_____"); //hex(0,4)
        System.out.println();
