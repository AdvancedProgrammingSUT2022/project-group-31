...
import dk.ilios.asciihexgrid.CharGrid;
...
public class AsciiBoard {
    ...
    private dk.ilios.asciihexgrid.printers.AsciiHexPrinter printer;
    private dk.ilios.asciihexgrid.CharGrid grid;
    ...
    private dk.ilios.asciihexgrid.CharGrid createGrid() {
